...
<p align="center">
  ...
  <a href="https://deepwiki.com/8treenet/goraven"><img src="https://deepwiki.com/badge.svg" alt="Ask DeepWiki" /></a>
</p>
...
```bash
docker pull 8treenet/goraven:v0.5.4
```

> 国内网络拉取较慢时，可使用以下镜像仓库地址拉取，拉取后重命名为统一镜像名：
> ```bash
> # 以 docker.1panel.live 为例
> docker pull docker.1panel.live/8treenet/goraven:v0.5.4
> docker tag docker.1panel.live/8treenet/goraven:v0.5.4 8treenet/goraven:v0.5.4
> ```
