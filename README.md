...
Raven is a self-hostable Agent, with isolated workspaces for every team member. It assembles models, tools, knowledge, files, skills, and workflows into a single runtime environment where agents can take on tasks, invoke tools, read documents, write code, and compound capabilities across sessions.
