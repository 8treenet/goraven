...
var settingRegistry = []settingMeta{
	...
	{key: "tools.websearch_enabled", valueType: po.ValueTypeBool, defaultValue: "true",
		displayNameZh: "免费网页搜索", displayNameEn: "Free Web Search",
		descriptionZh: "启用无需 API Key 的 DuckDuckGo 网页搜索，返回标题、链接和摘要。公开搜索服务可能会限流或调整页面结构。",
		descriptionEn: "Allow keyless DuckDuckGo web search with titles, links, and snippets. Public search services may rate-limit requests or change their page structure.",
